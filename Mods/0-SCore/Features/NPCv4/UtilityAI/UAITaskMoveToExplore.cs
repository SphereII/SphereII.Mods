...
namespace UAI
{
    public class UAITaskMoveToExploreV4 : UAITaskMoveToTarget
    {
        ...
        public override void Update(Context _context)
        {
            ...
            DoorUtils.CheckForClosedDoor(_context);

            if (PathingUtils.IsBlocked(_context))
            {
        ...
        {
            if (CombatUtils.HasBuff(_context, _buff))
            {
                EntityUtilities.Stop(_context.Self.entityId);
        ...
        public override void Start(Context _context)
        {
            ...
            if (path?.Count > 0)
            {
                ...
                PathingUtils.FindPath(_context, _vector + Vector3.forward, false);
        ...
        private void GetItemFromContainer(Context _context, TileEntityLootContainer tileLootContainer)
        {
            ...
            //   CombatUtils.SetLookPosition(_context,blockPos);
        ...
        private bool CheckContainer(Context _context)
        {
            ...
            //    CombatUtils.SetLookPosition(_context, _vector);
