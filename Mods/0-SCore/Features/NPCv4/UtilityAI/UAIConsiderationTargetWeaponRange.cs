...
namespace UAI
{
    ...
    public class UAIConsiderationNotInWeaponRangeV4 : UAIConsiderationInWeaponRangeV4
    {
    ...
    public class UAIConsiderationInWeaponRangeV4 : UAIConsiderationTargetDistance
    {
        ...
        public override float GetScore(Context context, object target)
        {
            ...
            if (!VisionUtils.CanShoot(context.Self, entityAlive, range))
            {
                return 0f;
            }
