...
namespace UAI
{
    public class UAIConsiderationNotPathBlockedSDXV4 : UAIConsiderationPathBlockedSDXV4
    {
    ...
    public class UAIConsiderationPathBlockedSDXV4 : UAIConsiderationPathBlocked
    {
