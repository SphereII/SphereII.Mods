...
namespace UAI
{
    public class UAITaskMoveToHealTargetSDXV4 : UAITaskMoveToTarget
    {
        ...
        public override void Update(Context _context)
        {
            ...
            // CombatUtils.SetLookPosition(_context, _position);
        ...
        public override void Start(Context _context)
        {
            ...
            PathingUtils.FindPath(_context, _position, run);
