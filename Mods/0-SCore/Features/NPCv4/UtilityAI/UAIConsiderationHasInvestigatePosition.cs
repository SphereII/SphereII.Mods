namespace UAI
{
    ...
    /// </summary>
    public class UAIConsiderationHasInvestigatePositionV4 : UAIConsiderationBase
    {
    ...
    /// </summary>
    public class UAIConsiderationHasNoInvestigatePositionV4 : UAIConsiderationBase
    {
        public override float GetScore(Context _context, object target)
        {
            if (target is not EntityAlive entityAlive)
