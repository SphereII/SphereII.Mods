namespace UAI
{
    ...
    public class UAIConsiderationTargetIsAllyV4 : UAIConsiderationTargetIsEnemyV4
    {
    ...
    public class UAIConsiderationTargetIsFriendlyV4 : UAIConsiderationTargetIsEnemyV4
    {
        public override float GetScore(Context _context, object target)
        {
            return EntityUtilities.SameValue(base.GetScore(_context, target), 1f) ? 0f : 1f;
    ...
    public class UAIConsiderationTargetIsEnemyV4 : UAIConsiderationTargetFactionStanding
    {
