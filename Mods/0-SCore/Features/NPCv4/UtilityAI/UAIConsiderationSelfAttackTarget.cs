...
namespace UAI
{
    public class UAIConsiderationSelfNotAttackTargetV4 : UAIConsiderationSelfAttackTargetV4
    {
    ...
    public class UAIConsiderationSelfAttackTargetV4: UAIConsiderationBase
    {
        public override float GetScore(Context _context, object target)
        {
