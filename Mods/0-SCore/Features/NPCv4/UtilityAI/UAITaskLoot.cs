...
namespace UAI
{
    public class UAITaskLootV4 : UAITaskMoveToTarget
    {
        ...
        public override void Update(Context _context)
        {
            ...
            if ( _leader)
                CombatUtils.SetCrouching(_context, _leader.IsCrouching);

            if (ContainerUtils.CheckContainer(_context, _vector))
            {
        ...
        public override void Start(Context _context)
        {
            ...
            hadBuff = false;
            // sort
            paths.Sort((a, b) => _context.Self.GetDistanceSq(a).CompareTo(_context.Self.GetDistanceSq(b)));
            _vector = paths[0];
            if (paths.Count > 5 )
            {
            ...
            PathingUtils.FindPath(_context, _vector, false);
