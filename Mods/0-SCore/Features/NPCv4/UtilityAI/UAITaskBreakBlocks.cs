...
namespace UAI
{
    public class UAITaskBreakBlockV4 : UAITaskAttackTargetEntity
    {
        ...
        public override void Stop(Context _context)
        {
            ...
            CombatUtils.SetWeapon(_context);
            base.Stop(_context);
        }
        ...
        public override void Update(Context _context)
        {
            ...
            if (_context.Self.IsBreakingDoors)
            {
                if (fleePosition == Vector3.zero)
                {
                    ...
                    PathingUtils.FindPath(_context, fleePosition, true);
                }
            ...
            if (DoorUtils.CheckForClosedDoor(_context)) return;
