...
namespace UAI
{
    public class UAITaskMoveToHealTargetV4 : UAITaskMoveToTarget
    {
        ...
        public override void Update(Context _context)
        {
            ...
            if (entityAlive != null)
            {
              //  CombatUtils.SetLookPosition(_context, entityAlive);
     ...
     //           feedInventoryData.invData.holdingEntity.MinEventContext.ItemValue = _itemStack.itemValue;
       //         feedInventoryData.invData.holdingEntity.FireEvent(MinEventTypes.onSelfHealedOther, true);
        ...
        public override void Start(Context _context)
        {
            ...
            var entityAlive = UAIUtils.ConvertToEntityAlive(_context.ActionData.Target);
            if (entityAlive != null)
                PathingUtils.FindPath(_context, entityAlive.position, true);
