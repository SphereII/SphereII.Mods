...
namespace Harmony.UtilityAI
{
    public class UAIBasePatches
    {
        ...
        {
            /// <summary>
            /// This prefix adds the entity itself to the list of target entities. It is needed
            /// for the <see cref="UAIFilterIsSelf"/> filter to work.
            /// </summary>
            ...
            public static bool Prefix(Context _context)
            {
                ...
                _context.ConsiderationData.EntityTargets.Add(_context.Self);
