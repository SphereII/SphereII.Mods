...
namespace GlobalSnowEffect
{
    ...
    public partial class GlobalSnow : MonoBehaviour
    {
        ...
        void ReadFromModlet()
        {
            ...
            resourceReference = $"#@modfolder({BetterBiomeEffects.modFolder}):Resources/GlobalSnow.unity3d?";
          ...
          //   var biomes = System.IO.Path.Combine(worldLocation.FullPath, "biomes.png");
          //   if (!System.IO.File.Exists(biomes)) return;
          //   var biomesTex = TextureUtils.LoadTexture(biomes, FilterMode.Point, false, false, null);
          //   var snowColor = new Color(1, 1, 1);
          //   Color pixA;
          //   for (var i = 0; i < biomesTex.width; i++)
          //   { 
          //       for (var j = 0; j < biomesTex.height; j++)
          //       {
          //           pixA = biomesTex.GetPixel(i, j);
          //           pixA.a = snowColor == pixA ? 1 : 0;
          //           biomesTex.SetPixel(i, j, pixA);
          //       }
          //   }
          //
          //   biomesTex.Apply();
          // //  System.IO.File.WriteAllBytes(@"C:\Builds\biomes.png", biomesTex.EncodeToPNG());
          //
          //   coverageMaskTexture = biomesTex;
          //   _coverageMask = true;
        }
