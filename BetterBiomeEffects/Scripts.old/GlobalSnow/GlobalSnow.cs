...
namespace GlobalSnowEffect {
    ...
    public partial class GlobalSnow : MonoBehaviour {
        ...
        void LoadResources() {
            ...
            if (deferred) {
                ...
                if (snowedSpeedTreeBillboardShader == null) {
                    snowedSpeedTreeBillboardShader = DataLoader.LoadAsset<Shader>($"{resourceReference}SpeedTreeBillboardAdapted");
                }
            ...
            {
                depthShaderMask = DataLoader.LoadAsset<Shader>($"{resourceReference}DepthCopyMask");
            ...
            if (decalMat == null) {
                Shader decalShader = DataLoader.LoadAsset<Shader>($"{resourceReference}DecalDraw");
            ...
            if (blurMat == null)
            {
                Shader blurShader = DataLoader.LoadAsset<Shader>($"{resourceReference}DepthBlur");
            ...
            {
                snowParticleIllumOpaqueMat = Instantiate(DataLoader.LoadAsset<Material>($"{resourceReference}SnowParticleIllumOpaque"));
            }
            if (snowDustMat == null)
            {
        ...
        public void UpdateSnowfallProperties() {
            ...
            if (_snowfall) {
                if (snowfallSystem == null) {
                    GameObject go = Instantiate(DataLoader.LoadAsset<GameObject>($"{resourceReference}SnowParticleSystem"));
