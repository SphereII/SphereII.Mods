...
//            private static void Postfix(global::Progression __instance, ref FastTags[] ___xpFastTags, int _exp, string _cvarXPName = "_xpOther", XPTypes _xpType = XPTypes.Other, bool useBonus = true)
//            {
//                if (__instance.parent as EntityAliveSDX == null) return;
...
//                    num = EffectManager.GetValue(PassiveEffects.PlayerExpGain, null, num, __instance.parent, null, ___xpFastTags[(int)_xpType], true, true, true, true, 1, true);
//                }
//                if (num > 214748370f)
//                {
//                    num = 214748370f;
