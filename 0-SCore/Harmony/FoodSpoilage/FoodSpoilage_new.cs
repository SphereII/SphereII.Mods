...
//     [HarmonyPatch("Clone")]
//     public class FoodSpoilageItemValueClone {
//         public static void Postfix(ref ItemValue __result) {
//             if ( __result.HasMetadata(KeyNextSpoilageTick))
//                 __result.SetMetadata(KeyNextSpoilageTick, -1, TypedMetadataValue.TypeTag.Integer);
//         }
//     }
//
...
//                 !itemClass.Properties.GetBool(PropSpoilable)) return true;
//             
...
//             {
//                 // Debug.Log($"Slot Throttled: {__instance.SlotNumber} : {nextTick}");
//                 return true;
//             }
//             return false;
//         }
...
//             }
//             // if (__instance.ItemStack.itemValue.HasMetadata(KeyNextSpoilageTick))
//             // {
