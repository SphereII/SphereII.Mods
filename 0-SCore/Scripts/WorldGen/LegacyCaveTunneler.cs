...
public static class LegacyCaveSystem
{
    ...
    private static BlockValue caveAir = new BlockValue((uint) Block.GetBlockByName("caveBlock02").blockID);
...
// Changes the blocks. This works better when doing the cave openings, vs the prefab
    public static void PlaceAround(Chunk chunk, Vector3i position, bool isPillar = false)
    {
