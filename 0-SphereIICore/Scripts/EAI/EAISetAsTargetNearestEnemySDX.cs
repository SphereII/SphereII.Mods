...
class EAISetAsTargetNearestEnemySDX : EAISetNearestEntityAsTarget
{
    ...
    ////    // Disabling original functionality, as its being mainpulated by the Harmony patch under 0-SphereIICore/Harmony/EAITarget.cs
