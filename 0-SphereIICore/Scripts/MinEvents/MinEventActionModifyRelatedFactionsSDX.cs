...
/// -->
/// <triggered_effect trigger="onSelfBuffStart" action="ModifyRelatedFactionsSDX, Mods" target="self" faction="bandits" value="10" related="whisperers" />
/// 
/// <!--
...
/// -->
/// <triggered_effect trigger="onSelfBuffStart" action="ModifyRelatedFactionsSDX, Mods" target="self" faction="bandits" value="10" related="whisperers" scale="0.5" />
///
/// <!--
...
/// -->
/// <triggered_effect trigger="onSelfPrimaryActionEnd" action="ModifyRelatedFactionsSDX, Mods" target="self" faction="whiteriver" value="-10" related="bandits,redteam,blueteam,greenteam" />
/// 
/// <!--
...
public class MinEventActionModifyRelatedFactionsSDX : MinEventActionTargetedBase
{
        ...
        for (int i = 0; i < targets.Count; i++)
        {
            ...
            if (entity != null)
            {
                ...
                if (otherFaction != null)
                {
                    ...
                    if (debug)
                    {
                        Debug.Log(string.Format("relationship to {0} modified by {1}", faction, value));
                    }
    ...
    private void ModifyRelatedFactionRelationships(byte targetEntityFactionId, Faction otherFaction)
    {
        ...
        for (int i = 0; i < relatedFactions.Length; i++)
        {
                ...
                relatedFaction.ID != targetEntityFactionId)
            {
                ...
                if (debug)
                {
                    Debug.Log(string.Format("relationship to {0} modified by {1}", relatedFactions[i], modifier));
                }
            }
        }
    }
    ...
    private float CalculateRelatedFactionModifier(float relationshipToFaction)
    {
        ...
        float relationshipToTarget = ratio * value * scale;
